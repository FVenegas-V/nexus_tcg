...
class _RatingDialogScreenState extends State<RatingDialogScreen>
      ...
      child: Column(
        children: [
          ...
          RatingStars(
            ...
            starSize: 48,
            isInteractive: !widget.isReadOnly, // Enable interaction
  ...
  Future<void> _submitRating() async {
    ...
    try {
      ...
      // Invalidar cache de reputación para refrescar estadísticas
      if (mounted) {
        final reputationProvider = Provider.of<ReputationProvider>(
          context,
          listen: false,
        );
        reputationProvider.clearUserCache(widget.targetUserId);
        debugPrint(
          '🗑️ [REPUTATION] Cache invalidado para usuario ${widget.targetUserId}',
        );
      }
